// Supabase Edge Function: proxy GitHub Contents API for prod-schedule/data/shifts.json
...
const PATH = "prod-schedule/data/shifts.json";
...
Deno.serve(async (req) => {
  ...
  const ghHeaders: Record<string, string> = {
    ...
    "User-Agent": "atome-github-shifts-fn",
  };
